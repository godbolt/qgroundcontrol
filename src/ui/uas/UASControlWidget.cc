...
#elif defined(QGC_USE_UALBERTA_MESSAGES)
#define CONTROL_MODE_MANUAL "DIRECT MANUAL"
#define CONTROL_MODE_GUIDED "MODE MID-L CMDS"
#define CONTROL_MODE_AUTO   "AUTOMATIC CONTROL"
#define CONTROL_MODE_TEST1  "SCALED MANUAL"
#define CONTROL_MODE_TEST2  "MODE SEL PT"
